...
An example app can be found in the [PCloudSDKExample]() folder. The example app demonstrates how to authenticate a user and how to list a user`s files and folders.
