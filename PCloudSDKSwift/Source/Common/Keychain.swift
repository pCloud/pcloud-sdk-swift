...
struct Keychain {
	...
	@discardableResult static func set(_ value: Data, forKey key: String) -> Bool {
		let query = self.query(attributes: [
			kSecAttrAccount as String: key,
	...
	/// - returns: Whether the operation was successful.
	@discardableResult static func deleteData(forKey key: String) -> Bool {
	...
	static func query(attributes: [String: Any]) -> CFDictionary {
		var copy = attributes
